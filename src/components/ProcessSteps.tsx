      ...
      <div className="max-w-[1512px] mx-auto px-6 lg:px-[100px]">
        ...
        <div className="flex items-center mb-8">
          ...
          {currentIndex > 0 && (
            <button 
              onClick={prevCards}
              className="flex items-center justify-center transition-all duration-200 hover:scale-110 z-10 p-4 rounded-full hover:bg-gray-100 mr-4"
            >
          ...
          <div className="flex-1 overflow-hidden"> 
            ...
            >
              {steps.map((step, index) => (
                <div key={index} className="w-1/2 md:w-1/3 lg:w-1/4 flex-shrink-0 px-4">
                  <div className="space-y-6">
                    <p className="text-xl md:text-2xl font-medium text-black">{step.number}</p>
                    <h3 className="text-xl md:text-2xl font-medium text-black min-h-[50px] md:min-h-[60px]">{step.title}</h3>
                    <p className="text-base md:text-lg leading-[20px] md:leading-[23px] font-normal text-black">
                      {step.description}
                    </p>
                  </div>
                </div>
          ...
          {currentIndex < maxIndex && (
            <button 
              onClick={nextCards}
              className="flex items-center justify-center transition-all duration-200 hover:scale-110 z-10 p-4 rounded-full hover:bg-gray-100 ml-4"
            >
